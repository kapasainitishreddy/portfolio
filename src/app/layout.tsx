      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var t=localStorage.getItem('snrk_theme');document.documentElement.setAttribute('data-theme',(t==='ink'||t==='calligraphy'||t==='samurai')?t:'ink');var m=localStorage.getItem('snrk_mode');document.documentElement.setAttribute('data-mode',(m==='light'||m==='dark')?m:'dark');}catch(e){document.documentElement.setAttribute('data-theme','ink');document.documentElement.setAttribute('data-mode','dark');}})();`,
          }}
        />
      </head>
      <body>
