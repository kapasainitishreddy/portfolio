...
A self-contained alternate portfolio for Sai Nitish Reddy Kapa. It lives in its
own folder and does not change the existing Next.js portfolio.

## Preview

```bash
cd screenplay-portfolio
...
- Split screenplay and Director's Cut theater themes
